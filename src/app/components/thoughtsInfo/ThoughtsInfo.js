...
const ThoughtsInfo = ({
  ...
  return (
    <Link href={href} passHref>
        <div className="metal-texture metal-ruby-effect rounded-lg m-1 sm:m-3 p-3 sm:p-4 md:pb-2 relative min-h-[120px] sm:h-40 lg:h-45 transition duration-200 ease-in-out flex flex-col">
